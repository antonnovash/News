...
/*const insertStatement = `INSERT INTO news (
...
func CreateHandler(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		_, err = main.database.Exec(`INSERT INTO news (id, title, publishedDate) VALUES ('id', 'title', 'publishDate')`, id, title, publishedDate)
